...
MP4TrackId MP4File::AddG726AudioTrack(uint32_t timeScale)
{
	uint32_t fixedSampleDuration = (timeScale * 20) / 1000; // 20mSec/Sample
	...
	(void)AddChildAtom(MakeTrackName(trackId, "mdia.minf.stbl.stsd"), "g726");
	...
	SetTrackIntegerProperty(trackId,
		"mdia.minf.stbl.stsd.g726.timeScale",
		timeScale << 16);
